          ...
          >
            ...
            */}
            <div className="flex flex-col gap-2">
              <Link
                href="/#shop"
                className="gloss gloss-chalk gloss-loud rounded-2xl px-6 py-4 text-center text-2xl font-bold tracking-tight text-ink transition-transform hover:scale-[1.02] active:scale-[0.99]"
              >
